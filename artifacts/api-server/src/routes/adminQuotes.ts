...
/* ── POST /api/admin/quotes/:id/duplicate — copy any quote for its original owner ── */
router.post("/admin/quotes/:id/duplicate", requireAdmin, async (_req, res) => {
  ...
  try {
    ...
    console.error("POST /admin/quotes/:id/duplicate error:", err);
