...
export async function sendWelcomeEmail(
  ...
  const subject = "Welcome to Aloha WebCalculator — Your Account Details";
  ...
  const html = `
    <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 24px;color:#1e293b">
      ...
      <p style="font-size:14px;color:#334155;margin:0 0 24px">
        An admin has created an account for you on <strong>Aloha WebCalculator</strong>.
...
${message}
      ...
      <p style="font-size:12px;color:#94a3b8;margin:0">
        You received this message because you are a registered user of Aloha WebCalculator.
      </p>
    </div>
  `;
